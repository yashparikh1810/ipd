...
import caksicledata from './caksicledata'; // Adjust the path as necessary
...
const caksicle = () => {
  return (
   ...
   <img src={front} alt="Front Cake"  />
    ...
    <div className="popular-itemc">
      {caksicledata.map((product) => (
        <div key={product.id}>
             <Link to={`/cak/${product.id}`}>
