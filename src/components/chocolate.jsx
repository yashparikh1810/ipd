...
import ch from './chocodata'; // Adjust the path as necessary
...
const chocolate = () => {
  return (
    ...
    <p>Any celebration, whether a cozy gathering or party, is incomplete without Chocolates! We offer a wide range of handcrafted special chocolates that are a treat to the eyes and also the taste buds.</p>
