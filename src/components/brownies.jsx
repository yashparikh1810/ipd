...
import br from './browniedata'; // Adjust the path as necessary
...
const cupcakes = () => {
  return (
    ...
    <p>Any celebration, whether a cozy gathering or party, is incomplete without Brownies! We offer a wide range of handcrafted specialized brownies that are a treat to the eyes and also the taste buds.</p>
